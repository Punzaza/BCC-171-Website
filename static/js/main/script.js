...
window.addEventListener('scroll',()=>{const containerNames=['box1','box2','box3'];filterBox(containerNames);});let activeElement=null;let bands=document.querySelectorAll('.band');let concertOverlay=document.querySelector('.concert-overlay');let spotlight=document.querySelector('.spotlight');let header=document.querySelector('.concert-header');function focusBand(element){if(activeElement){activeElement.classList.remove('focus');const container=element.querySelector('.band-image-container');const shadow=container.querySelector('.band-shadow');const shadow2=container.querySelector('.band-image');spotlight.style.opacity="0";shadow2.style.filter="none";shadow.style.opacity="0.5";header.style.scale="1";concertOverlay.style.opacity="1";bands.forEach((band)=>{if(band.classList.contains('unfocus')){band.classList.remove('unfocus');}
else{}});}
if(activeElement!==element){element.classList.add('focus');const container=element.querySelector('.band-image-container');const shadow=container.querySelector('.band-shadow');const shadow2=container.querySelector('.band-image');spotlight.style.opacity="1";shadow.style.opacity="0";shadow2.style.filter="drop-shadow(4px 4px 6px rgb(0, 9, 22))";header.style.scale="0.8";concertOverlay.style.opacity="0";bands.forEach((band)=>{if(band.classList.contains('focus')){}
else{band.classList.add('unfocus');const container=band.querySelector('.band-image-container');const shadow=container.querySelector('.band-shadow');const shadow2=container.querySelector('.band-image');shadow.style.opacity="0.5";shadow2.style.filter="none";}});activeElement=element;}else{activeElement=null;}}
function headerAnimationX(){var body=document.body;var bodyWidth=body.offsetWidth;var scrollWidth=body.scrollWidth;var scrollPosition=window.pageXOffset||body.scrollLeft||document.documentElement.scrollLeft;var bodyHeight=body.offsetHeight;var scrollHeight=body.scrollHeight;var scrollPosition2=window.pageYOffset||body.scrollTop||document.documentElement.scrollTop;const header=document.getElementById('header');const hand=document.getElementById('hand');const hand2=document.getElementById('hand2');const head=document.getElementById('chongkoHead');const prepare=document.getElementById('prepare');const prepare2=document.getElementById('prepare2');const prepare3=document.getElementById('prepare3');const prepare4=document.getElementById('prepare4');const prepare5=document.getElementById('prepare5');const prepare6=document.getElementById('prepare6');const prepare7=document.getElementById('prepare7');const prepare8=document.getElementById('prepare8');const didYouKnow=document.getElementById('did-you-know');const didYouKnow2=document.getElementById('did-you-know2');const didYouKnow3=document.getElementById('did-you-know3');const paperplane=document.getElementById('header-paperplane');const children=document.querySelectorAll('.headerChild');var scrollPercentage=(scrollPosition+window.innerWidth)/ scrollWidth*100;var scrollPercentage2=(scrollPosition2+window.innerHeight)/ scrollHeight*100;function easeInOutCubic(t){return t<0.5?4*t*t*t:1+Math.pow(-2*t+2,3)/ 2;}
